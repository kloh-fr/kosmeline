...
const jsVendorDestination = './app/public/wp-content/themes/kosmeline/js/';
...
const jsCustomDestination = './app/public/wp-content/themes/kosmeline/js/';
...
const imgDST = './app/public/wp-content/themes/kosmeline/img/';
...
const zipName = 'kosmeline.zip';

// Must be a folder outside of the zip folder.
const zipDestination = './../'; // Default: Parent folder.
const zipIncludeGlob = ['./app/public/wp-content/themes/**/*']; // Default: Include all files/folders in current directory.
...
const textDomain = 'kosmeline';

// Name of the translation file.
const translationFile = 'kosmeline.pot';

// Where to save the translation files.
const translationDestination = './app/public/wp-content/themes/kosmeline/languages';

// Package name.
const packageName = 'Kosmeline';

// Where can users report bugs.
const bugReport = 'https://www.kloh.ch/contact/';

// Last translator Email ID.
const lastTranslator = 'Luc Poupard <contact@kloh.ch>';

// Team's Email ID.
const team = 'Luc Poupard <contact@kloh.ch>';
