...
<body <?php body_class(); ?> role="document" itemscope itemtype="https://schema.org/WebPage">
	...
	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 50 50" aria-hidden="true">
		...
		<symbol id="corbeille">
			<path d="M4.8 14l2.4 31.7C7.3 48.1 9.5 50 12 50h26c2.6 0 4.6-1.9 4.8-4.3L45.2 14H4.8zm12 29.8c-.8 0-1.4-.6-1.4-1.3L14 21.7c-.1-.8.6-1.4 1.3-1.4.8-.1 1.4.6 1.4 1.3l1.4 20.8c.1.7-.5 1.3-1.3 1.4zm9.6-1.4c0 .8-.6 1.4-1.4 1.4s-1.4-.6-1.4-1.4V21.6c0-.8.6-1.4 1.4-1.4s1.4.6 1.4 1.4v20.8zm8.3.1c-.1.7-.6 1.3-1.4 1.3h-.1c-.8-.1-1.3-.7-1.3-1.4l1.4-20.8c.1-.8.7-1.3 1.4-1.3.8.1 1.3.7 1.3 1.4l-1.3 20.8zM47 3.4H34.9l-.4-2.3C34.3.5 33.8 0 33.2 0H16.9c-.6 0-1.1.5-1.2 1.1l-.3 2.3H3c-.8 0-1.5.7-1.5 1.6v5.4c0 .8.7 1.5 1.5 1.5h44c.8 0 1.5-.7 1.5-1.5V5c0-.9-.7-1.6-1.5-1.6z" />
		</symbol>
		<symbol id="fleche">
